...
var Logger = function () {
  ...
  (0, _createClass3.default)(Logger, [{
    ...
    value: function debug() {
      ...
      var str = _util.format.apply(undefined, ['' + _ansiStyles2.default.grey.open + chevron + ' [DEBUG] ' + args.shift()].concat((0, _toConsumableArray3.default)(args), [_ansiStyles2.default.grey.close]));
